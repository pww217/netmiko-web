...
while True:
    ad_hoc_or_input_file = input('Are you making config changes from a file? (y/n): ')
    if ad_hoc_or_input_file not in ('y', 'n'):
        print('Not a valid response\n')
        continue
    if ad_hoc_or_input_file == 'y':
